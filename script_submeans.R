...
if (var=="tg"){df_var <- df_tg;data_source <- "eobs";var_label <- "Temperature (°C)";extreme <- "min";path <- "~/Documents/Data/Winter/submeans_eobs/"}
...
grid.arrange(p_tg, p_t2m, ncol=1, nrow = 2)
